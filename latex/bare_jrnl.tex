...
\begin{abstract}
This paper presents a systematic literature review examining the role of cybersecurity in information systems in organizations. The review encompasses studies published between 2017 and 2023 and aims to identify the significance and context of cybersecurity in information systems, examine key findings, and evaluate methodological approaches employed in the research. A systematic review of relevant research indexed the Scopus database.

The findings reveal the growing importance of cybersecurity in information systems across organizations, with a heightened focus on mitigating cyber threats, protecting sensitive data, ensuring secure network infrastructure, and addressing vulnerabilities. Various aspects of cybersecurity, including risk assessment, incident response, access controls, encryption, and employee awareness, are explored in the literature. The research also highlights the evolving nature of cyber threats and the need for continuous adaptation and improvement in cybersecurity measures.

By synthesizing the existing literature, this review enhances the understanding of the role of cybersecurity in information systems within organizations. It provides insights into the current state of research, identifies research gaps, and suggests avenues for future investigations. This study contributes to the body of knowledge by raising awareness of the significance of cybersecurity in safeguarding information systems and promoting a proactive approach to addressing cybersecurity challenges within organizational contexts.
\end{abstract}
